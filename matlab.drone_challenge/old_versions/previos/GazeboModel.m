classdef GazeboModel < handle
    %GazeboModel - Class controlling individual models in Gazebo
    %   M = GazeboModel(varargin) creates an object that allows for easy
    ...
    methods
        function obj = GazeboModel(varargin)
            %GazeboModel Constructor
