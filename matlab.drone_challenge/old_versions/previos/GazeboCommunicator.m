classdef GazeboCommunicator < handle
    %GazeboCommunicator - Class for communicating with Gazebo
    %   G = GazeboCommunicator() creates an object that allows for easy
    ...
    %
    %   See also GazeboModel, GazeboSpawnedModel
    ...
    properties (Access = ?GazeboSpawnedModel)
    ...
    methods (Access = public)
        function obj = GazeboCommunicator()
            %GazeboCommunicator Constructor
        ...
        function varargout = spawnModel(obj, buildModel, varargin)
            ...
            if nargout ==1
                varargout{1} = GazeboSpawnedModel(modName,obj);
            end
        end
    ...
    methods (Access = ?GazeboSpawnedModel)
